export default function Footer() {
  return (
    <footer className="w-full bg-primary text-surface-container-lowest">
      <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop pt-stack-lg pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter mb-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              />
              <span className="font-headline-sm text-headline-sm font-bold">Hybrid</span>
            </div>
          ...
          {/* Column 2: Links */}
          <div>
            <h4 className="font-label-md text-white mb-6 tracking-wider">COMPAÑÍA</h4>
            <ul className="space-y-4">
              <li><a className="text-on-primary-container hover:text-secondary-fixed transition-colors" href="#">Network Solutions</a></li>
              <li><a className="text-on-primary-container hover:text-secondary-fixed transition-colors" href="#">Infrastructure</a></li>
              <li><a className="text-on-primary-container hover:text-secondary-fixed transition-colors" href="#">About Us</a></li>
              <li><a className="text-on-primary-container hover:text-secondary-fixed transition-colors" href="#">Contact</a></li>
            </ul>
          </div>
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="font-body-md text-on-primary-container text-[14px]">
            © 2024 Hybrid Telecomunicaciones. All rights reserved. Precision in Connectivity.
          </p>
          <div className="flex gap-8">
            <a className="font-body-md text-on-primary-container text-[14px] hover:text-white transition-colors" href="#">Privacy Policy</a>
            <a className="font-body-md text-on-primary-container text-[14px] hover:text-white transition-colors" href="#">Terms of Service</a>
            <a className="font-body-md text-on-primary-container text-[14px] hover:text-white transition-colors" href="#">Carrier Relations</a>
          </div>
        </div>
